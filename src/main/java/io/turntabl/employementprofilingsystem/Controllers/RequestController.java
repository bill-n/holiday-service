...
//        try {
//            HolidayRequestMail.requestMessage("ali.fuseini@turntabl.io", request.getFrom() ,"Holiday Request", startDate, reportDate, request.getRequester_name());
//        } catch (IOException e) {
//            e.printStackTrace();
...
public class RequestController {
    ...
    public void makeARequest(@RequestBody RequestTO request) {
        ...
        try {
            RequestMail.requestMessage(System.getenv("APPROVERS_MAIL"), request.getFrom() ,"Holiday request", startDate, reportDate, request.getRequester_name());
        } catch (IOException e) {
            e.printStackTrace();
        } catch (GeneralSecurityException e) {
            e.printStackTrace();
