...
public class RequesterMail {
    public static void requestMessage(String to, String from, String subject, String request_start_date, String request_report_date, String requester_email) throws IOException, GeneralSecurityException {
        String bodyText = "<!doctype html>\n" +
                ...
                "              <p style=\"font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; Margin-bottom: 15px; color: black;\">Holiday request by " + requester_email + "</p>\n" +
                ...
                "                    <tbody>\n" +
                "                      <tr>\n" +
                "                      <td style=\"font-family: sans-serif; font-size: 14px; vertical-align: top; background-color: #3498db; border-radius: 5px; text-align: center;\"> <a href = \"https://cnn.com\" target=\"_blank\" style=\"display: inline-block; color: #ffffff; background-color: green; border: solid 1px green; border-radius: 5px; box-sizing: border-box; cursor: pointer; text-decoration: none; font-size: 14px; font-weight: bold; margin: 0; padding: 12px 25px; text-transform: capitalize; border-color: green;\"> Take Action Biggie </a> </td>\n" +
                "                    </tr>\n" +
                "                    </tbody>\n" +
                "                  </table>\n" +
                "                  </td>\n" +
