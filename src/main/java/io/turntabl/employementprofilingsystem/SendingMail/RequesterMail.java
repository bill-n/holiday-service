...
public class RequesterMail {
    public static void requestMessage(String to, String from, String subject, String requester_start_date, String requester_end_date, String requester_name) throws IOException, GeneralSecurityException {
        String bodyText = "<!doctype html>\n" +
                ...
                "                    <tbody>\n" +
                "                      <tr>\n" +
                "                      <td style=\"font-family: sans-serif; font-size: 14px; vertical-align: top; background-color: #3498db; border-radius: 5px; text-align: center;\"> <a href = \"https://holiday-request.herokuapp.com\" target=\"_blank\" style=\"display: inline-block; color: #ffffff; background-color: green; border: solid 1px green; border-radius: 5px; box-sizing: border-box; cursor: pointer; text-decoration: none; font-size: 14px; font-weight: bold; margin: 0; padding: 12px 25px; text-transform: capitalize; border-color: green;\"> Take Action </a> </td>\n" +
                "                    </tr>\n" +
                "                    </tbody>\n" +
                "                  </table>\n" +
                "                  </td>\n" +
